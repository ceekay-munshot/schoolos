...
export const healthMetrics: HealthMetric[] = [
  {
    ...
    action: "Class 7 is holding at grade pace but not pulling ahead — Head of Curriculum to review the Number strand sequencing with the two Class 7 teachers.",
  ...
  },
  {
    ...
    action: "Class 5 carries the heaviest residual gap-debt (equivalent-fractions cluster). Coach to convene a fortnightly small-group pull until the root node clears.",
    owner: "Rohan D'Souza",
    confidence: "high",
  ...
  },
  {
    ...
    action: "Spaced-review coverage in Class 4 dipped after the term break. Teachers to reinstate the weekly recall worksheet for Number and Measurement.",
  ...
  {
    key: "path",
    label: "PATH participation & progress",
    value: 0.91,
    unit: "ratio",
    momDelta: 0.03,
    trend: [
    ...
    action: "Class 6 Athlete cohort is thin on rising standard-of-work artifacts. Coach to confirm each child has a named specialise-stage project this term.",
    owner: "Rohan D'Souza",
    confidence: "medium",
    goodWhenRising: true,
  },
  {
    key: "usage",
    label: "System usage & data capture",
    value: 0.94,
    unit: "ratio",
    momDelta: 0.01,
    trend: [
    ...
    action: "Capture in Class 4 Narmada slips on Fridays. Operations to move the afternoon scan to before the PATH block and check the second station's calibration.",
    owner: "Priya Nair",
    confidence: "high",
    goodWhenRising: true,
  },
  {
    key: "parents",
    label: "Parent engagement & retention",
    value: 0.86,
    unit: "ratio",
    momDelta: 0.02,
    trend: [
    ...
    action: "Class 8 parents open the app least and two have not booked the term check-in. Coach to call them personally before the window closes.",
    owner: "Rohan D'Souza",
    confidence: "medium",
    goodWhenRising: true,
  },
...
export const syncHealth: SyncRow[] = [
  { surface: "Worksheet capture", pending: 0, oldestPending: "—", state: "synced" },
  ...
  { surface: "PATH artifacts", pending: 1, oldestPending: "Maker Workshop · 35 minutes ago", state: "pending" },
];
...
export const peopleSections: PeopleSection[] = [
  ...
  { section: "Class 6 · Yamuna", teacher: "Anindita Bose", assistant: "Farah Sheikh", adoption: 0.95, independence: 0.88, followThrough: 0.9 },
  {
    ...
    independence: 0.73,
    followThrough: 0.81,
    support: "New to the campus this term. Paired with Lakshmi Krishnan for two co-planning sessions on running the self-work block — early signs are already improving.",
  },
...
export const earlyWarningRows: EarlyWarningRow[] = [
  {
    studentId: "stu-riya",
    evidence: "Equivalent-fractions node has held at Gap for three weeks; it is now breaking her column addition in captured worksheets.",
    confidence: "high",
    nextStep: "Pull into the equivalent-fractions small group; repair the root node before introducing addition of unlike fractions.",
    owner: "Lakshmi Krishnan",
    followUpDate: "2026-06-25",
  },
  {
    studentId: "stu-ishaan",
    evidence: "Gap-debt rising for three consecutive weeks across Number; independent-work ratio drifting down with it.",
    confidence: "high",
    nextStep: "Include in the same small-group pull; coach to add a fortnightly check-in on confidence, not just accuracy.",
    owner: "Rohan D'Souza",
    followUpDate: "2026-06-24",
  },
  {
    studentId: "stu-reyansh",
    evidence: "Retention integrity slipped to 0.66 — three previously-mastered Number nodes failed recall this fortnight.",
    confidence: "high",
    nextStep: "Reinstate a spaced-review worksheet twice weekly; recheck recall on the three faded nodes in ten days.",
    owner: "Lakshmi Krishnan",
    followUpDate: "2026-06-28",
  },
  {
    studentId: "stu-kabir",
    evidence: "Shares the equivalent-fractions gap with the Class 5 cluster; pace has eased below grade-expected this month.",
    confidence: "medium",
    nextStep: "Same small group as Riya; a single targeted worksheet should clear it given his strong builder reasoning.",
    owner: "Lakshmi Krishnan",
    followUpDate: "2026-06-26",
  },
  {
    studentId: "stu-diya",
    evidence: "Works carefully but slowly; the equivalence gap is the bottleneck and retention has eased to 0.74.",
    confidence: "medium",
    nextStep: "Small-group pull plus extra processing time on the diagnostic; avoid timed practice until the node clears.",
    owner: "Lakshmi Krishnan",
    followUpDate: "2026-06-27",
  },
  {
    studentId: "stu-shaurya",
    evidence: "Recurring 'adds denominators straight across' pattern flagged by the tutor over two weeks; gap-debt now at 2.",
    confidence: "medium",
    nextStep: "Teacher to confirm the misconception in person, then assign a common-denominator support worksheet.",
    owner: "Anindita Bose",
