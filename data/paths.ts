...
export const pathDefs: Record<PathKey, PathDef> = {
  builder: {
    ...
    name: "Builder",
    verb: "Make things",
    blurb: "Build something new every few months. Try it, fix it, try again.",
    glyph: "⚒",
  },
  explorer: {
    key: "explorer",
    name: "Explorer",
    verb: "Follow your curiosity",
    blurb: "Pick something you love for a few weeks and dig in. Look, guess, check, try again.",
    glyph: "✺",
  },
  scholar: {
    key: "scholar",
    ...
    blurb: "Go deep in subjects you love — reasoning, proof, and the start of the olympiad path.",
    glyph: "❖",
  },
  athlete: {
    key: "athlete",
    name: "Athlete",
    verb: "Move and compete",
    blurb: "Try lots of sports, then train hard in the one you love.",
    glyph: "➤",
  },
  artist: {
    key: "artist",
    name: "Artist",
    verb: "Make and create",
    blurb: "Try many art forms, then build real skill and your own style.",
    glyph: "✣",
  },
  communicator: {
    key: "communicator",
    name: "Communicator",
    verb: "Speak and move people",
    blurb: "From speaking up and listening to debate, storytelling and theatre.",
    glyph: "❝",
  },
};
